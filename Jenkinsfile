            ...
            steps {
                script {
                    ...
                    withSonarQubeEnv() {
                        ...
                        bat "\"${scannerHome}\\SonarScanner.MSBuild.exe begin /k:"sam" /n:"My C# and C++ project" /v:"1.0" /d:sonar.cfamily.build-wrapper-output="build_wrapper_output_directory"
                        bat "\"${msbuildHome}\\build-wrapper-win-x86-64.exe --out-dir build_wrapper_output_directory MSBuild.exe /t:Rebuild
